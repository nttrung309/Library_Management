...
namespace DemoDesign
{
    public partial class Report : Form
    {
        ...
        private void CategoryReport()
        {
            ...
            foreach (ReportByCategory report in reportByCategory)
            {
                report.rate = $"{((float)report.numsOfBorrowings / totalNumOfBorrowings) * 100}%";
            }

            bindingCategory = new BindingSource();
            bindingCategory.DataSource = reportByCategory;
            dtgv.DataSource = bindingCategory;
        ...
        private void ChangeDtgvLayout(int i)
        {
            ...
            else
            {
                ...
                dtgv.Columns[2].HeaderText = "Ngày mượn";
                dtgv.Columns[3].HeaderText = "Số ngày trả trể";
